/*
Prioridades
Este exemplo demonstra a prioridade das operações aritméticas no 
Portugol. As operações como os parênteses podem ser utilizados para
alterar esta prioridade, fazendo com que uma operação de soma antes
...
programa {
  funcao inicio() {
    ...
    // Neste exemplo, a operação de multiplicação (*) será executada primeiro resultado
